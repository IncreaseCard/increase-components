...
storiesOf('Calendar', module)
  ...
  .add('dominicana', () => {
    ...
    const renderDay = (date, inMonth) => (
      <React.Fragment>
        <CalendarData inMonth={inMonth} style={{ color: '#f79c31' }}>
          <Currency currency="DOP" language="es-DO" value={200 * Math.random()} />
        </CalendarData>
        <CalendarData inMonth={inMonth} style={{ color: '#2ca8df' }}>
          <Currency currency="DOP" language="es-DO" value={250 * Math.random()} />
        </CalendarData>
      </React.Fragment>
    );
    ...
    const renderWeeklySummary = () => (
      <React.Fragment>
        <CalendarData inMonth={true} style={{ color: '#f79c31' }}>
          <Currency currency="DOP" language="es-DO" value={7 * 200 * Math.random()} />
        </CalendarData>
        <CalendarData inMonth={true} style={{ color: '#2ca8df' }}>
          <Currency currency="DOP" language="es-DO" value={5 * 250 * Math.random()} />
        </CalendarData>
      </React.Fragment>
    );
    return (
